...
public struct MoviesListViewModelActions {
    ...
    public let showMovieDetails: (Movie) -> Void
    public let showMovieQueriesSuggestions: (@escaping (_ didSelect: MovieQuery) -> Void) -> Void
    public let closeMovieQueriesSuggestions: () -> Void
    
    public init(showMovieDetails: @escaping (Movie) -> Void,
                showMovieQueriesSuggestions: @escaping (@escaping (_ didSelect: MovieQuery) -> Void) -> Void,
                closeMovieQueriesSuggestions: @escaping () -> Void) {
...
public enum MoviesListViewModelLoading {
    case fullScreen
    case nextPage
}

public protocol MoviesListViewModelInput {
    func viewDidLoad()
...
public protocol MoviesListViewModelOutput {
...
public typealias MoviesListViewModel = MoviesListViewModelInput & MoviesListViewModelOutput

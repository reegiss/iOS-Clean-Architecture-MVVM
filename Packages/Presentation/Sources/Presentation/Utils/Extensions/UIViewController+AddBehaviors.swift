...
extension ViewControllerLifecycleBehavior {
    ...
    public func viewDidDisappear(viewController: UIViewController) {}
    public func viewWillLayoutSubviews(viewController: UIViewController) {}
    public func viewDidLayoutSubviews(viewController: UIViewController) {}
}
